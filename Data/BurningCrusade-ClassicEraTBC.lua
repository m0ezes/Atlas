...
db.AtlasMaps = {
	...
	CL_AuchAuchenaiCrypts = {
		...
		LevelRange = "64-70",
		Acronym = L["AC"],
		-- instanceID = 558, -- for later use maybe?		https://warcraft.wiki.gg/wiki/InstanceID#Classic
		DungeonID = 149,
		DungeonHeroicID = 178,
		WorldMapID = 256,
		Module = "Atlas_BurningCrusade",
	...
	CL_AuchManaTombs = {
		...
		LevelRange = "63-70",
		Acronym = L["MT"],
		-- instanceID = 557, -- for later use maybe?
		DungeonID = 148,
		DungeonHeroicID = 179,
		WorldMapID = 272,
		Module = "Atlas_BurningCrusade",
	...
	CL_AuchSethekkHalls = {
		...
		Location = { BZ["Terokkar Forest"] },
		LevelRange = "66-70",
		-- instanceID = 556, -- for later use maybe?
		DungeonID = 150,
		DungeonHeroicID = 180,
		Acronym = L["Seth"],
		WorldMapID = 258,
	...
	CL_AuchShadowLabyrinth = {
		...
		Location = { BZ["Terokkar Forest"] },
		LevelRange = "69-70",
		-- instanceID = 555, -- for later use maybe?
		DungeonID = 151,
		DungeonHeroicID = 181,
		Acronym = L["SL"],
		WorldMapID = 260,
	...
	CL_CFRSerpentshrineCavern = {
		...
		Location = { BZ["Zangarmarsh"] },
		LevelRange = "70+",
		-- instanceID = 548, -- for later use maybe?
		DungeonID = 194,
		Acronym = L["SSC"],
		PlayerLimit = { 25 },
		WorldMapID = 332,
	...
	CL_CFRTheSlavePens = {
		...
		Location = { BZ["Zangarmarsh"] },
		LevelRange = "61-69",
		-- instanceID = 547, -- for later use maybe?
		DungeonID = 140,
		DungeonHeroicID = 184,
		Acronym = L["SP"],
		WorldMapID = 265,
	...
	CL_CFRTheSteamvault = {
		...
		MinLevel = { 65, 69 },
		Acronym = L["SV"],
		-- instanceID = 545, -- for later use maybe?
		DungeonID = 147,
		DungeonHeroicID = 185,
		WorldMapID = 263,
	...
	CL_CFRTheUnderbog = {
		...
		Location = { BZ["Zangarmarsh"] },
		LevelRange = "62-70",
		-- instanceID = 546, -- for later use maybe?
		DungeonID = 146,
		DungeonHeroicID = 186,
		Acronym = L["UB"],
		WorldMapID = 262,
		...
		{ WHIT..INDENT..Atlas_GetBossName("Claw <Swamplord Musel'ek's Pet>") },
	...
	CL_HCBloodFurnace = {
		...
		Location = { BZ["Hellfire Peninsula"] },
		LevelRange = "60-68",
		-- instanceID = 542, -- for later use maybe?
		DungeonID = 137,
		DungeonHeroicID = 187,
		Acronym = L["BF"],
		WorldMapID = 261,
	...
	CL_HCHellfireRamparts = {
		...
		{ WHIT.." 3) "..Atlas_GetBossName("Vazruden", 529),                                                              529 },
	...
	CL_HCTheShatteredHalls = {
		...
		{ GREY..INDENT..L["Drisella"]..ALC["L-Parenthesis"]..FACTION_HORDE..ALC["Comma"]..ALC["Heroic"]..ALC["R-Parenthesis"] },
	...
	ZulAman = {
		...
		PlayerLimit = { 10 },
		Acronym = L["ZA"],
		-- instanceID = 568, -- for later use maybe?
		DungeonID = 197,
		WorldMapID = 333,
		-- JournalInstanceID = 77,
		Module = "Atlas_BurningCrusade",
		{ BLUE.." A) "..ALC["Entrance"],                                                               10001 },
		{ WHIT.." 1) "..Atlas_GetBossName("Akil'zon <Eagle Avatar>", 186),                             186 },
		{ WHIT.." 2) "..Atlas_GetBossName("Nalorakk <Bear Avatar>", 187),                              187 },
		{ GREN..INDENT..L["The Map of Zul'Aman"] },
		{ WHIT.." 3) "..Atlas_GetBossName("Jan'alai <Dragonhawk Avatar>", 188),                        188 },
		{ WHIT.." 4) "..Atlas_GetBossName("Halazzi <Lynx Avatar>", 189),                               189 },
		...
		{ WHIT.." 6) "..Atlas_GetBossName("Zul'jin") },
